...
<div class="main-banner header-text">
      <div class="container-fluid">
        <div class="owl-banner  owl-carousel">
          ...
          <div class="item">
          <img height="400px" src="upload/<?php echo $postdata['post_img']; ?>" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span><?php echo $postdata['cat_name']; ?></span>
                </div>
                <a  href="single_post.php?view=postview&&id=<?php echo $postdata['post_id']; ?>"><h4 class="text-info"><?php echo $postdata['post_title']; ?></h4></a>
                <ul class="post-info">
